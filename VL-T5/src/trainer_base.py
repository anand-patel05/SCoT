...
class TrainerBase(object):
    ...
    def create_config(self):
        ...
        config = config_class.from_pretrained(self.args.backbone, local_files_only=True)
    ...
    def create_optimizer_and_scheduler(self, total_train_num):
        ...
        if 'adamw' in self.args.optim:
            ...
            no_decay = [
                "bias", "LayerNorm.weight", "input_norm.weight",
            ]
            ...
            # lr_scheduler = get_constant_schedule_with_warmup(     # earlier was this
            #     optim, warmup_iters)
    ...
    def load_checkpoint(self, ckpt_path):
        ...
        if self.verbose:
            ...
            print("Missing keys:", results.missing_keys)
            print("Unexpected keys:", results.unexpected_keys)
            pprint(results)
